/* import { IntcodeComputer } from './day_9_part_1.mjs' */
...
const IntcodeComputer = (IntcodeProgram, input) => {
  ...
  for (let i = 0; i < IntcodeProgram.length;) {
    ...
    let parameter3 = IntcodeProgram[i + 3]
    ...
    if (IntcodeProgram[i] >= 100) {
      ...
      if (instruction.length === 5) {
        ...
        if (instruction[0] === 2) { parameter3 = IntcodeProgram[(IntcodeProgram[i + 3] + relativeBase)] }
      }
    }
    ...
    if (opcode === 1) {
      const positionToChange = parameter3
...
// const array = [109, 1, 204, -1, 1001, 100, 1, 100, 1008, 100, 16, 101, 1006, 101, 0, 99]
// const array = [104, 1125899906842624, 99]
// const array = [1102, 34915192, 34915192, 7, 4, 7, 99, 0]
...
const newArray = IntcodeComputer(array, 1)
